# This is my package laravel-pdf-ua
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/bambamboole/laravel-pdf-ua/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/bambamboole/laravel-pdf-ua/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-pdf-ua.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-pdf-ua)
...
```bash
php artisan vendor:publish --tag="laravel-pdf-ua-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-pdf-ua-views"
```

## Usage

```php
$pdfUA = new Bambamboole\PdfUA();
echo $pdfUA->echoPhrase('Hello, Bambamboole!');
```
